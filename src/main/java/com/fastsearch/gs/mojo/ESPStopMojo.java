 ...
 */
public class ESPStopMojo extends AbstractMojo
{
   /**
    * Customer name.
    * 
   ...
   */
   ...
   public void execute(  ) throws MojoExecutionException
   {
      ...
      try
      {
         ...
         {
            getLog(  ).info( "----------------------------------------------------------------------------" );
            getLog(  ).info( "FAST ESP Project Lifecycle Manager: Executing 'stop' goal..." );
         }
         ...
         boolean hostSetWasStopped = !hostSet.someRunning(  );
         
         if( !hostSetWasStopped )
         {
            getLog(  ).info( "Stopping ESP:" );
            hostSet.stop(  );
         }
         ...
         if( hostSetWasStopped )
            getLog(  ).info( ">> ESP was not running, did nothing." );
         else if( !hostSet.isRunning(  ) )
            getLog(  ).info( ">> ESP has been successfully stopped on all hosts." );
         else
            getLog(  ).info( ">> Could not successfully stop ESP on all hosts, manual inspection required." );
