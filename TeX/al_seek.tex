...
%%% Last Modified On: Sun Apr 11 18:30:38 1993
...
\insertpdf{landscap}{\label{fig:landscape}An image of the eye depicted
...
\insertpdf{lake18}{\label{fig:lake}The image in
...
\insertpdfwidth{octopus}{\label{fig:octopus}The {\em octopus\/} pixel
...
\insertpdfwidth{octoiq}{\label{fig:IQ}The principle behind the
...
\insertpdfwidth{candidat}{\label{fig:candidate}The distribution of the
...
\insertpdfwidth{plausibl}{\label{fig:plausible}The division of the
