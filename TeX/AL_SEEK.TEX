...
%%% Last Modified On: Tue Apr  6 13:01:12 1993
...
constant, and that the image is of size $N\times N$, this number is
$O(N)$.  It should be noted, however, that each of these operations
consists of looking up a boolean value in an array, and thus is very
cheap computationally.  Nevertheless, the overall number of operations
for the swimming octopus search algorithm as presented above is
$O(N)$.
