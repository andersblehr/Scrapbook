...
%
% Bruksmaate:
%   \inserteps{filnavn}{figurtekst\label{fig:labref}}
%
% X-utstrekningen til figuren settes til 0.8 ganger tekstbredden.
%

\newcommand{\inserteps}[2]{\insertepswidth{#1}{#2}{0.8}}

%
% \insertepswidth[3]
%
% Bruksmaate:
%   \insertepswidth{filnavn}{figurtekst\label{fig:labref}}{bredde}
%
