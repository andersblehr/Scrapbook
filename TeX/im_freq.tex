...
\insertpdf{convolut}{\label{fig:convolution}Graphical illustration of
  convolution.}
...
\insertpdf{lowpass}{\label{fig:lowpass}Cross section of an ideal
...
\insertpdf{highpass}{\label{fig:highpass}Cross section of an ideal
...
\insertpdfwidth{homomorp}{\label{fig:homomorphic}A homomorphic filter
