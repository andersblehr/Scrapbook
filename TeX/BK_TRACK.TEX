...
%%% Last Modified On: Thu Mar 11 06:39:25 1993
...
A development of Robinson's method is the so-called {\em double
...
\insertepswidth{tv}{\label{fig:back:track:tv}{\em Principle of the
    infrared TV-camera method\/}: {\sf v\/} and {\sf h\/} designate
  the vertical and horizontal windows, respectively, and
  $(x_{1},x_{2})$ and $(y_{1},y_{2})$ denote the detected margins of
  the pupil.}{0.45}
