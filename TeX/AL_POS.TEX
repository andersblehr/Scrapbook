...
%%% Last Modified On: Sun Apr  4 19:15:11 1993
...
\insertepswidth{profile}{\label{fig:profile}(a) The profile of a pixel
  row in an image. (b) The result of applying the mask in
  Fig.~\protect\ref{fig:sobelop}(b) to this profile.}{0.5}
...
\insertepswidth{myprofil}{\label{fig:myprofile}(a) The profile of the
  image in Fig.~\protect\ref{fig:testimages}(d) along a southeastwards
  detection line passing through the pupil. (b) The result of applying
  the NW (left) and SE (right) Sobel mask of
  Fig.~\protect\ref{fig:masks} to this profile.  $O_{O}$ designates 
  the origin of operation.}{0.5}
