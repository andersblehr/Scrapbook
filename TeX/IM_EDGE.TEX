...
%%% Last Modified On: Sat Mar 20 05:10:19 1993
...
\insertepswidth{sobelop}{\label{fig:sobel}Spatial masks used to
  ...
  and~(\protect\ref{eq:sobel:y}).}{0.5}
...
\inserttwoeps{histbl05}{gradbl05}{\label{fig:gradient}An image of a
  monkey's eye (a), and the result of applying the Sobel operators in
  Fig.~\protect\ref{fig:sobel} on this image (b).}
